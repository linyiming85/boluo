...
<section id="banner" class="blete-section-wrapper">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h1>SHIDLK JLADSKJ  LSAKDJ LK LDSAKJ FIWOQEJ SADL KJS OI </h1>
            </div>
        </div>
    </div>
</section>
<section class="blete-section-wrapper" id="blete-slider">
    <div class="sp-slides">
